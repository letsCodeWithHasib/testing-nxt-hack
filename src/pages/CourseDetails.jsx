...
const CourseDetailPage = () => {
  ...
  const course = courses[id]; // Find the course by ID
  console.log(course, id);

  if (!course) {
    return <div className="mt-[75px]">Course not found!</div>;
  }

  return (
    <div className="min-h-screen mt-[75px] bg-gray-100 py-10 px-4 md:px-[100px]">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        <div className="text-4xl text-purple-700 mb-6">
